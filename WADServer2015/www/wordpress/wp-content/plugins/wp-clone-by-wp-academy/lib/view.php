    ...
    if ( isset($_GET['mode']) && 'advanced' == $_GET['mode'] ) { ?>
        <div class="info" >
            <table>
                ...
                <tr><td colspan="2"><h3>Exclude directories from backup, and backup database only</h3></td></tr>
                <tr><td colspan="2"><p>Depending on your web host, WP Clone may  not work for large sites.
                ...
                <tr><th></th><td colspan="2"><p>Enter one per line, i.e.  <code>uploads/backups</code>,use the forward slash <code>/</code> as the directory separator. Directories start at 'wp-content' level.</p></td></tr>
            </table>
        </div>
<?php
}
