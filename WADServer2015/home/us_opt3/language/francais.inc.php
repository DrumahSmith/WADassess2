...
define('F_TIMEOUT',"Fonction timed out!<br>La cause est dû probablement à une base de données est trop grande.<br>Agrandissez les valeurs des directives PHP \"memory_limit\" and \"max_execution_time\" (voir <a href=\"http://php.net/ini.list\" target=\"_blank\">PHP manual</a>).");
...
define('B_DELETE_ALL_2',"Effacer TOUTES les sauvegardes");
...
define('EX_PACKED',"Tout compresser dans un fichier ZIP");
...
/*get_file.php*/
define("GF_INVALID_EXT","Seuls les fichiers avec l'une des extensions suivantes sont visibles: .php, .php3, .html, .htm, .sql, .sql.zip, .sql.gz");
