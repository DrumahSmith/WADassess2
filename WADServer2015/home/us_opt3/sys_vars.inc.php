...
// === Get root path ==========================================================
  $path_array = explode("\\us_opt3",dirname(__FILE__)); // Split at folder
...
//Force these phpMyBackupPro variables:
$CONF['sql_passwd'] = $password;  //Default Root
$CONF['sql_user']   = "root";     //Default Root
$CONF['sql_host']   = htmlspecialchars_decode("127.0.0.1:".$port_ini);
$CONF['no_login']   = "1";        //Disable login 0=Enable

$update=TRUE; // Force above changes everytime phpMyBackupPro is run
//### End US Modifications -----------------------------------------------------
