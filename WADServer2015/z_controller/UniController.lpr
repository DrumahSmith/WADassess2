...
uses
  ...
  root_www_pass_access_form, root_ssl_pass_access_form,
  php_extensions_form, edit_php_basic_form, msmtp_php_mail_form,
  are_servers_runable, httpsend, server_internet_status_form,
  pc_win_startup_form, dtdns_form, cron_form, lazcontrols, 
command_line_start_up, mysql_db_create_delete_form, 
...
begin
  Application.Title:='WADserver2015';
  ...
  Application.CreateForm(Tmysql_create_restricted_user, 
    mysql_create_restricted_user);
