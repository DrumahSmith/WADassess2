...
begin
 ...
 Else        //--My NOT running
  ...
  //=== Main Menu ==============================================
   ...
   If (DirectoryExists(US_PHP52) or DirectoryExists(US_PHP53) or DirectoryExists(US_PHP54) or DirectoryExists(US_PHP55) or DirectoryExists(US_PHP56) or DirectoryExists(US_PHP70)) Then
    begin
