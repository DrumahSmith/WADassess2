...
//@line 10 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 17 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
  if (!this.isPanel())
    this._elem.addEventListener("MozMouseHittest", this, false);
  else
//@line 21 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 64 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
    if (!isPanel) {
      if (this.shouldDrag(aEvent))
        aEvent.preventDefault();
      return;
    }
//@line 70 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 81 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
        if (isPanel) {
...
//@line 94 "e:\mozdev\pm24ESR\toolkit\modules\WindowDraggingUtils.jsm"
        break;
      case "mousemove":
